...
const Drops = () => {
  ...
  const handleChoNgoi = (seat) => {
    setSelectedSeats((prevSelectedSeats) => {
      if (prevSelectedSeats.some(s => s.soGhe === seat.soGhe)) {
        return prevSelectedSeats.filter((s) => s.soGhe !== seat.soGhe);
      } else {
  ...
  return (
    <div className="bg z-20 ">
      <div className='container flex flex-row space-x-28    '>
        <div>
        ...
        <div className='space-y-10 mt-20 bookingMovie relative'>
          ...
          <div className='square bg-green-500 '>
            <span className='absolute left-16 text-2xl'>Ghế đang chọn : 0</span>
          </div>
          <div className='square bg-white '>
            <span className='absolute left-16 text-2xl'>Ghế chưa chọn : 118</span>
          </div>

          <div>
            <span className='text-3xl text-red-500'>Tổng tiền : </span>
          </div>
